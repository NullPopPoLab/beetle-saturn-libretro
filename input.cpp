...
static const unsigned input_map_wheel_shift_left  = RETRO_DEVICE_ID_JOYPAD_L;
static const unsigned input_map_wheel_shift_right = RETRO_DEVICE_ID_JOYPAD_R;
...
void input_update_with_bitmasks( retro_input_state_t input_state_cb )
{
	...
	for ( unsigned iplayer = 0; iplayer < players; ++iplayer )
	{
		...
		int32_t ret         = input_state_cb( iplayer, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_MASK );
